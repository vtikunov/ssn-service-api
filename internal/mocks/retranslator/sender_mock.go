...
// Source: github.com/ozonmp/ssn-service-api/internal/retranslator/sender (interfaces: EventSender)
...
func (m *MockEventSender) Send(arg0 *subscription.ServiceEvent) error {
	m.ctrl.T.Helper()
