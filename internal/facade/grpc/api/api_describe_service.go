...
func (o *serviceAPI) DescribeServiceV1(ctx context.Context, req *pbf.DescribeServiceV1Request) (*pbf.DescribeServiceV1Response, error) {
	...
	return &pbf.DescribeServiceV1Response{
