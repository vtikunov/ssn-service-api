# Ozon Marketplace Subscription Service API
...
```sh
[I] ➜ grpc_cli call localhost:8082 DescribeServiceV1 "id: 1"
connecting to localhost:8082
Rpc failed with status code 5, error message: service not found
```
...
```sh
$ pgcli "postgresql://docker:docker@localhost:5432/ssn_service_api"
```
